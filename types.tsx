...
export type AppDrawerStackParamList = {
    [AppDrawerNavigationKey.AppTabs]: NavigatorScreenParams<AppTabsStackParamList> | undefined;
};

export type RootStackParamList = {
    [RootNavigatekey.AppDrawer]: NavigatorScreenParams<AppDrawerStackParamList> | undefined;
...
export type AppTabsStackScreenProps<Screen extends keyof AppTabsStackParamList> = CompositeScreenProps<
    ...
    CompositeScreenProps<DrawerScreenProps<AppDrawerStackParamList>, NativeStackScreenProps<RootStackParamList>>
>;
